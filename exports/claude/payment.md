...
This skill provides guidance for AI agents working with VTEX Payment Connector Development. Apply these constraints and patterns when assisting developers with apply when designing, or implementing a payment connector in vtex io. covers ppf implementation in vtex io, use of secure proxy, manifest and other ppp routes exposure and clients definitions. use for any implementation of a payment connector hosted in vtex io.
