# AGENTS.md — Well-Architected Commerce & Solution Architecture

These instructions guide AI agents working on VTEX Well-Architected Commerce & Solution Architecture tasks.
Follow these patterns and constraints when assisting developers.

## well-architected-commerce
