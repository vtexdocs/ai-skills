...
- [masterdata-storage-strategy](masterdata-masterdata-storage-strategy.md) — When to use MD, `v-*` schema extensions reference, indexing strategy, triggers, capacity planning
