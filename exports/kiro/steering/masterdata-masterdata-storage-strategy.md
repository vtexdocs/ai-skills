<!-- globs: masterdata/**/*.json, **/dataentities/** -->
...
- [vtex-io-masterdata](vtex-io-vtex-io-masterdata.md) — IO app integration: MasterDataClient, `masterdata` builder, CRUD patterns
- [vtex-io-application-performance](vtex-io-vtex-io-application-performance.md) — Caching layers and BFF patterns when exposing MD data
- [architecture-well-architected-commerce](architecture-architecture-well-architected-commerce.md) — Cross-cutting storage and architecture principles
